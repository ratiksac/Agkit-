...
_DESCRIPTION = """
Database containes Grapes images and its labels
"""
...
#the name of the class is the name use for tfds database
class Grapes(tfds.core.GeneratorBasedBuilder):
  """GrapesBuilder for dataSet dataset."""
  ...
  def _info(self) -> tfds.core.DatasetInfo:
    ...
    return tfds.core.DatasetInfo(
        ...
        features=tfds.features.FeaturesDict({
            ...
            'image': tfds.features.Image(shape=(416, 416, 3)), #this is the expected shape before this we got to cast all the images to match this
